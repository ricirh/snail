#ifndef __SNAIL_SOCKET_H__
#define __SNAIL_SOCKET_H__
...
namespace snail
{
    ...
    public:
        ...
        static Socket::ptr CreateTCP(snail::Address::ptr address);
        static Socket::ptr CreateUDP(snail::Address::ptr address);
        ...
        bool getOption(int level, int option, T &result)
        {
            ...
            return getOpion(level, option, &result, &length);
        }
